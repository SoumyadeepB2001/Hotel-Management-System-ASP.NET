...
namespace HotelManagementSystemWebApp.Home.HomePage
{
    public partial class check_in : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Session["query"] = "SELECT b_id, guest_name, guest_address, dob, gender, email, phone, id_proof, id_num, check_in, check_out, r_num, room_price, total_price, deposit, no_of_adults, no_of_children FROM guest_info, bookings WHERE guest_info.g_id = bookings.g_id AND has_checked_in='NO' AND has_checked_out='NO' AND check_in = CONVERT(date, GETDATE())";
