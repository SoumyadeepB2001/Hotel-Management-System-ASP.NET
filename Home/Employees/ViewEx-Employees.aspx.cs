...
{
    public partial class ViewEx_Employees : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Session["link"] = "/Home/Employees/ViewEx-Employees.aspx";
                Response.Redirect("/Login/Login.aspx");
            }

            else
            {
                Session["query"] = "SELECT * FROM employees WHERE is_terminated = 'YES'";
