...
{
    public partial class ViewManagers : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Session["link"] = "/Home/Employees/ViewManagers.aspx";
                Response.Redirect("/Login/Login.aspx");
            }

            else
            {
                Session["query"] = "SELECT * FROM employees WHERE designation = 'Manager' OR designation = 'General Manager'";
