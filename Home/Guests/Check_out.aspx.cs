...
namespace HotelManagementSystemWebApp.Home.Guests
{
    public partial class Check_out1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Session["link"] = "/Home/Guests/Check_out.aspx";
                Response.Redirect("/Login/Login.aspx");
            }

            else
            {
                Session["query"] = "SELECT b_id, guest_info.g_id, guest_name, guest_address, dob, gender, email, phone, check_in, check_out, r_num, no_of_adults, no_of_children, checked_in_at FROM guest_info, bookings WHERE guest_info.g_id = bookings.g_id AND has_checked_in='YES' AND has_checked_out='NO'";
