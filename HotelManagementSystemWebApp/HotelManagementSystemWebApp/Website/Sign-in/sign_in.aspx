<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sign_in.aspx.cs" Inherits="HotelManagementSystemWebApp.Website.Sign_in.sign_in" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="form-group">
            <asp:Button ID="btnSignIn" runat="server" Text="Log-in" OnClick="btnSignIn_Click" class="btn btn-primary btn-block"/>
        </div>
        <div class="clearfix">
